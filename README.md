...
两套策略均从顶部区间结束后至少 2 根 K 线开始找，参考点相对该波起点需在第 7 至 25 根 K 线（索引差、含边界）内，选择首个合格点；参考收盘不得高于顶部，且允许最多比该波起点收盘低 3%，距顶部回撤不得超过 28%。一波的参考点是准入条件，二波的参考点用于择时，并非二波结构入选的新增硬条件。一波在参考点后最多观察 10 根，参考点后价格反弹达到 8%、价格收盘或观察期间最低收盘跌破 1起超过 3%，或参考点之后任一日线 J 达到 60，均退出本轮候选。二波在当前上涨段对应参考点后最多观察 10 根，任一日线 J 达到 60 也退出本轮候选；J 判断回看参考点之后的全部日线，即使价格后来重新突破顶部也不会恢复。缺口不会放宽周期、支撑或回撤约束。
