...
class WaveStructureSelector:
    ...
    def __init__(
        ...
        timing_j_rebound_exit_threshold: float = 60.0,
        timing_max_observation_after_reference: int = 10,
        ...
        weekly_j_rebound_trough_max: float = 50.0,
        weekly_j_min_rebound: float = 8.0,
        weekly_j_recent_rising_weeks: int = 2,
        ...
        self.wave_config = {
            ...
            "timing_j_rebound_exit_threshold": float(timing_j_rebound_exit_threshold),
            "timing_max_observation_after_reference": max(
                1, int(timing_max_observation_after_reference)
            ),
            ...
            "weekly_j_rebound_filter_enabled": int(bool(weekly_j_rebound_filter_enabled)),
            "weekly_j_current_max": float(weekly_j_current_max),
            "weekly_j_rebound_lookback_weeks": max(1, int(weekly_j_rebound_lookback_weeks)),
            "weekly_j_rebound_prior_high_min": float(weekly_j_rebound_prior_high_min),
            "weekly_j_rebound_trough_max": float(weekly_j_rebound_trough_max),
            "weekly_j_min_rebound": float(weekly_j_min_rebound),
            "weekly_j_recent_rising_weeks": max(1, int(weekly_j_recent_rising_weeks)),
...
class OneWaveEntrySelector:
    ...
    def __init__(
        ...
        max_reference_rebound: float = 0.08,
        j_rebound_exit_threshold: float = 60.0,
        timing_j_rebound_scale: float = 30.0,
        timing_low_j_threshold: float = 10.0,
        timing_doji_body_ratio: float = 0.20,
        timing_doji_bonus: float = 3.0,
        ...
        max_pullback: float = 0.28,
        max_observation_after_reference: int = 10,
        support_close_tolerance: float = 0.03,
